    ...
    const experienceData = [
      {
        ...
        companyName: 'TechCorp, 2020 - Present',
        roles: [
        ...
        achievements: [
          ...
          'Led a team that delivered projects 15% ahead of schedule',
        ],
      },
    ];
    ...
    <section className="py-20">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {experiences.map((exp, index) => (
          <div key={index} className="col-span-2 bg-white p-6 rounded-lg shadow-md border border-gray-200">
        ...
        <div className="bg-emerald-100 p-6 rounded-lg shadow-md border border-emerald-200 flex flex-col justify-center">
          <h3 className="text-xl font-semibold mb-2 text-emerald-800">Key Achievements</h3>
          <ul className="list-disc list-inside text-emerald-700">
            {experiences.length > 0 &&
              experiences[0].achievements.map((achievement, achievementIndex) => (
